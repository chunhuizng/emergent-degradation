...
if __name__ == '__main__':
    ...
    parser.add_argument("--n_inject_max", type=int, default=500)
    parser.add_argument("--n_edge_max", type=int, default=100)
    ...
    if args.model is not None:
        ...
        model_list = config.adv_train_model_list
